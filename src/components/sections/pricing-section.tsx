...
export function PricingSection() {
  const plans = [
    {
      name: "Сайт",
      description: "Создание русскоязычного сайта для вашего бизнеса.",
      price: "от 49 000 ₽",
      duration: "разработка",
      features: [
    ...
    {
      name: "Продвижение",
      description: "Реклама и соцсети для привлечения клиентов в России.",
      price: "от 35 000 ₽",
      duration: "в месяц",
      features: [
        "Настройка Яндекс.Директ",
        "Ведение ВКонтакте / Telegram",
        "Создание контента",
        "Ежемесячные отчёты",
    ...
    {
      name: "Полный пакет",
      description: "Комплексный выход на российский рынок под ключ.",
      price: "от 80 000 ₽",
      duration: "в месяц",
      features: [
        "Сайт + лендинги",
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Выберите подходящий пакет — от создания сайта до полного продвижения на российском рынке.
              </p>
            </div>
          </div>
        </ScrollReveal>
